...
def check_bill_limit(tab: Tab):
    """Raise 402 if the tab has reached the free bill limit. No-op for pro tabs."""
    if tab.is_pro:
        return
...
def check_itemised_limit(tab: Tab):
    """Raise 402 if the tab has reached the free itemised bill limit. No-op for pro tabs."""
    if tab.is_pro:
        return
