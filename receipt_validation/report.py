...
_SCORE_COLUMNS = [
    ...
    ("item_total", "mean_item_total_accuracy"),
    ("name_fuzzy", "mean_item_name_fuzzy_match"),
    ("translated_fuzzy", "mean_item_translated_name_fuzzy_match"),
    ("quantity", "mean_item_quantity_accuracy"),
    ("price_per_qty", "mean_item_price_per_quantity_accuracy"),
    ("subtotal", "mean_subtotal_accuracy"),
    ("sum_vs_subtotal", "mean_items_sum_vs_subtotal"),
    ("charge_amount", "mean_charge_amount_accuracy"),
    ("charge_included", "mean_charge_included_flag_match"),
    ("charge_kind", "mean_charge_kind_match"),
    ("charge_count", "mean_charge_count_match"),
    ("item_adjustment", "mean_item_adjustment_amount_accuracy"),
